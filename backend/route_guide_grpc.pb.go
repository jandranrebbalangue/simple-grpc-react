...
type RouteGuideClient interface {
	...
	// as the rectangle may cover a large area and contain a
	...
	// Accepts a stream of RouteNotes send while a route is being traversed,
	// while receiving other ROuteNotes (e.g. from others users).
